        ...
        <>
            ...
            <div className='flex flex-col space-y-6 mt-5 ml-3'>
                ...
                <div className='max-w-2xl mx-auto text-xs text-black space-y-3'>
                    ...
                    <p>2. Point calculation formula: Point = Amount of GLMR spent / Probability, that means if Alice uses 100 GLMR and chooses a 10% probability and successfully mints, while Bob uses 1000 GLMR and chooses a 100% probability to mint, then ultimately Alice and Bob will obtain the same quantity of BALL.</p>
