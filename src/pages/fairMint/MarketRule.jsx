        ...
        <>
            ...
            <div className='flex flex-col space-y-6 mt-5 ml-3'>
                ...
                <div className='max-w-2xl mx-auto text-xs text-black space-y-3'>
                    <p>1. Users can mint an unlimited number of times. Each successful Mint will earn a certain number of Points. Ultimately, the share of the total BALL will be divided based on the proportion of an individual's Points to the total Points.</p>
                    <p>2. Point calculation formula: Point = Amount of ETH spent / Probability, that means if Alice uses 0.1 ETH and chooses a 10% probability and successfully mints, while Bob uses 1 ETH and chooses a 100% probability to mint, then ultimately Alice and Bob will obtain the same quantity of BALL.</p>
